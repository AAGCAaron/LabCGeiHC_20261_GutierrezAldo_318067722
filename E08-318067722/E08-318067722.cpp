...
int main()
{
	...
	*/
	...
	while (!mainWindow.getShouldClose())
	{
		...
		lightPosition = glm::vec3(mainWindow.getmuevex(), 5.0f, 6.0f + offsetZ);
		lightDirection = glm::normalize(glm::vec3(0.0f, -1.0f, offsetZ * 0.2f));
		...
		// Solo manda la luz si está encendida
